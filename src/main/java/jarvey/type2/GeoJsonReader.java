...
public class GeoJsonReader {
	public static Geometry read(String geoJson) throws JsonParseException, JsonMappingException, IOException {
		return GeoJsonReader.read(JsonParser.parse((String)geoJson));
	}
