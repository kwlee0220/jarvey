 ...
 * @author Kang-Woo Lee
 */
public class ShpScanBuilderOld implements ScanBuilder {
	@SuppressWarnings("unused")
	private static final Logger s_logger = LoggerFactory.getLogger(ShpScanBuilderOld.class);
	...
	public ShpScanBuilderOld(StructType schema, GeometryType geomType, Map<String,String> props,
